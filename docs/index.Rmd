...
#Error: HTTP failure: 400 The following OTT ids were not found: [5264367, 632176, 621380, 67823, 955367, 588763, 566119, 3634672, 1083518, 2841628]
tr <- tol_induced_subtree(setdiff(otl$ott_id, ott_notfound), label_format = 'name')
#Dropping singleton nodes with labels: Amphibalanus ott1042709, Creseis ott671266, Abylopsis ott4718809, Polysiphonia ott674045
