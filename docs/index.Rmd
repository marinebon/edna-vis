...
[ecoquants.shinyapps.io/edna-vis![edna-vis](img/screen.png)](https://ecoquants.shinyapps.io/edna-vis/)
...
- [**R  packages**](https://github.com/marinebon/edna-vis/blob/1229dca08d3471abeb940ae5ea8d1c9f553deb19/shiny/app.R#L5-L15) required by the app and `devtools` (eg `install.packages('devtools')` to install).
...
![screen-tree](img/screen-tree.png)
