...
- [**R packages**](https://github.com/marinebon/edna-vis/blob/1229dca08d3471abeb940ae5ea8d1c9f553deb19/shiny/app.R#L5-L15) required by the app. (To install R package shiny, simply run `install.packages('shiny')`.)
